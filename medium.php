...
<html lang="en">
  ...
  <?php include 'partials/_header.php'; ?>
    ...
    <div class="container">
      ...
      <h2 class="z my-2">Please select your Standared</h2>
      <div class="container my-5">

        <?php
        $medium = $_GET['medium'];

       $sql="SELECT DISTINCT `std`, `medium` FROM `que_ans` where `medium`='$medium' ORDER BY `std`";
    ...
    echo '
    <a href="sub.php?std='.$std.'&& medium='.$medium.'"><button type="button" id="btn" class="btn btn-outline-primary mx-1 my-1" style="">'.$std.'</button></a> 
    ';
    }
  ?>
